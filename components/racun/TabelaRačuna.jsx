...
const TabelaRačuna = () => {
    const struja = useSelector((state) => state.racun.struja);
    const voda = useSelector((state) => state.racun.voda);
    const smece = useSelector((state) => state.racun.smece);
    const kablovska = useSelector((state) => state.racun.kablovska);
    const mobitel = useSelector((state) => state.racun.mobitel);
    const iptv = useSelector((state) => state.racun.iptv);
