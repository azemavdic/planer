...
const Voda = ({ user }) => {
  ...
  const { data, isLoading } = useGetVodaQuery()
  const [izbrisiRacun] = useIzbrisiVodaMutation()
  ...
  const handleEditClick = (id) => {
    ...
    setEditedItem(data?.user?.voda.find((racun) => racun._id === id))
  }
  ...
  return (
    <Layout>
      <h2 className='mb-5 text-lg font-bold'>Voda</h2>
