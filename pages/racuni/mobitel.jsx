...
const Mobitel = ({ user }) => {
  ...
  const { data, isLoading } = useGetMobitelQuery()
  const [izbrisiRacun] = useIzbrisiMobitelMutation()
  ...
  const handleEditClick = (id) => {
    ...
    setEditedItem(data?.user?.mobitel.find((racun) => racun._id === id))
  }
  ...
  return (
    <Layout>
      <h2 className='mb-5 text-lg font-bold'>Mobitel</h2>
